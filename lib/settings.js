...
export const Options = class Options {
    ...
    _updateSettings() {
        ...
        */
        ...
        // Reserve space for the search entry, if needed
        if (!this.SHOW_SEARCH_ENTRY && this.SEARCH_APP_GRID_MODE && this.APP_GRID_PAGE_HEIGHT_SCALE > 0.9) {
            const scale = (this.APP_GRID_PAGE_HEIGHT_SCALE - 0.9) * 10;
