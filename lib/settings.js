...
var Options = class Options {
    ...
    _updateSettings() {
        ...
        this.DASH_BG_COLOR = this.get('dashBgColor', true);
        this.DASH_BG_RADIUS = this.get('dashBgRadius', true);
        this.DASH_BG_LIGHT = this.DASH_BG_COLOR === 1;
        this.DASH_BG_GS3_STYLE = this.get('dashBgGS3Style', true);
        this.DASH_POSITION = this.get('dashModule', true) ? this.get('dashPosition', true) : 2;
        ...
        */
        ...
        this.WINDOW_ICON_CLICK_ACTION = this.get('windowIconClickAction', true);
