...
var WorkspaceSwitcherPopupModule = class {
    ...
    update(reset) {
        this._moduleEnabled = opt.get('workspaceSwitcherPopupModule', true);
        const conflict = _Util.getEnabledExtensions('workspace-switcher-manager').length ||
                         _Util.getEnabledExtensions('WsSwitcherPopupManager').length;
