...
var DashModule = class {
    ...
    _activateModule() {
        ...
        if (opt.DASH_VERTICAL) {
            ...
            dash.add_style_class_name('horizontal');
    ...
    _resetStyle(dash) {
        ...
        dash.remove_style_class_name('horizontal');
...
const AppIconCommon = {
    ...
    activate(button) {
        ...
        const openNewWindow = this._shouldOpenNewWindow(appIsRunning, button, isCtrlPressed, targetWindowOnCurrentWs);
        ...
        } else if (this._shouldMoveToCurrentWorkspace(isShiftPressed, openNewWindow, nWindows)) {
    ...
    _shouldOpenNewWindow(appIsRunning, button, isCtrlPressed, targetWindowOnCurrentWs) {
    ...
    _shouldMoveToCurrentWorkspace(isShiftPressed, openNewWindow, nWindows) {
        return ((opt.DASH_SHIFT_CLICK_MV && isShiftPressed) ||
                ((opt.DASH_CLICK_PREFER_WORKSPACE || opt.DASH_ISOLATE_WS) && !openNewWindow)) &&
                nWindows > 0;
    },
