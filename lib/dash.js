...
export const DashModule = class {
    ...
    _activateModule() {
        ...
        if (opt.DASH_VERTICAL) {
            // this._overrides.addOverride('Dash', Ui.Dash.Dash.prototype, DashVerticalOverride);
...
const DashItemContainerCommon = {
    ...
    showLabel() {
        ...
        const recentWindowTitle = windows.length ? windows[0].get_title() : '';
...
const DashCommon = {
    ...
    handleDragOver(source, actor, x, y, _time) {
        ...
        if (pos !== this._dragPlaceholderPos && this._animatingPlaceholdersCount === 0) {
            ...
            // this._dragPlaceholder = new Ui.Dash.DragPlaceholderItem(); // not exported in 45
