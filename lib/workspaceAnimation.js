...
var WorkspaceAnimationModule = class {
    constructor(gi, ui, misc, me) {
        ...
        this.dummy = Ui.WorkspaceAnimation.MonitorGroup;
        opt = Me.opt;
    ...
    _overrideMonitorGroupProperty(reset = false) {
        if (!this._origBaseDistance)
            this._origBaseDistance = Object.getOwnPropertyDescriptor(Ui.WorkspaceAnimation.MonitorGroup.prototype, 'baseDistance').get;
            ...
            getter = {
                get() {
                    ...
                    if (global.workspace_manager.layout_rows === -1)
                        return this._monitor.height + spacing + (opt.PANEL_MODE ? Ui.Main.panel.height : 0); // compensation for hidden panel
                    else
        ...
        if (getter)
            Object.defineProperty(Ui.WorkspaceAnimation.MonitorGroup.prototype, 'baseDistance', getter);
    }
