...
const OverviewCommon = {
    show(state = Ui.OverviewControls.ControlsState.WINDOW_PICKER, customOverviewMode) {
        if (!customOverviewMode)
            this.resetOverviewMode();

        if (state === Ui.OverviewControls.ControlsState.HIDDEN)
        ...
        Ui.Main.layoutManager.showOverview();
    ...
    toggle(customOverviewMode) {
        ...
        if (this._visible)
            ...
            this.show(Ui.OverviewControls.ControlsState.WINDOW_PICKER, customOverviewMode);
    },
