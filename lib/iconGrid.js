...
export var IconGridModule = class {
    ...
    _activateModule() {
        ...
        this._overrides.addOverride('IconGrid', Ui.IconGrid.IconGrid.prototype, IconGridCommon);
        this._overrides.addOverride('IconGridLayout', Ui.IconGrid.IconGridLayout.prototype, IconGridLayoutCommon);
    }
    ...
    _findBestIconSize() {
        ...
        if (nColumns < 1 || nRows < 1) {
            ...
            if (this._isFolder) {
                ...
                // opt.APP_GRID_FOLDER_ICON_SIZE = iconSize;
            } else {
                iconSize = opt.APP_GRID_ICON_SIZE_DEFAULT;
                // opt.APP_GRID_ICON_SIZE = iconSize;
            }
            return iconSize;
        }
