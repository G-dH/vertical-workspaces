...
var WorkspacesViewModule = class {
    ...
    _activateModule() {
        ...
        const desktopCubeEnabled = _Util.getEnabledExtensions('desktop-cube@schneegans.github.com').length;
...
const WorkspacesDisplayCommon = {
    ...
    _onKeyPressEvent(actor, event) {
        ...
        case Clutter.KEY_space:
            ...
            } else if (opt.get('recentFilesSearchProviderModule') && _Util.isCtrlPressed()) {
