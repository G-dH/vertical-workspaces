...
const WorkspacesDisplayCommon = {
    ...
    _onKeyPressEvent(actor, event) {
        ...
        case Clutter.KEY_space:
            ...
            } else if ((opt.get('extensionsSearchProviderModule') || Me.Util.getEnabledExtensions('extensions-search-provider').length) && Me.Util.isCtrlPressed()) {
                Me.Util.activateSearchProvider(Me.ESP_PREFIX);
            } else if (opt.get('recentFilesSearchProviderModule') && Me.Util.isShiftPressed()) {
                Me.Util.activateSearchProvider(Me.RFSP_PREFIX);
            } else if (opt.get('windowSearchProviderModule') || Me.Util.getEnabledExtensions('windows-search-provider').length) {
