    ...
    _onKeyPressEvent(actor, event) {
        ...
        case Gi.Clutter.KEY_space:
            if (Me.Util.isCtrlPressed() && Me.Util.isShiftPressed()) {
                ...
                Me.Util.activateSearchProvider(Me.Modules.recentFilesSearchProviderModule._PREFIX);
            } else if (opt.get('windowSearchProviderModule')) {
                Me.Util.activateSearchProvider(Me.Modules.windowSearchProviderModule._PREFIX);
            }
