...
const AppFolderDialog = {
    ...
    _zoomAndFadeIn() {
        ...
        if (!opt.APP_GRID_FOLDER_CENTER) {
            ...
            const paddedAreaWidth = folderAreaWidth - 2 * xPadding;
            const dialogDiff = this.child.width - paddedAreaWidth;
            folderAreaX += xPadding - Math.round(dialogDiff > 0 ? dialogDiff / 2 : 0);
