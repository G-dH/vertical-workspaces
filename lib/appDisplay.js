...
const BaseAppViewCommon = {
    ...
    _redisplay() {
        ...
        // Avoid unnecessary updates at startup time
...
const FolderIcon = {
    ...
    open() {
        // "Prevent" switching page when an item on another page is selected
        // It actually switch the page, but after closing the folder dialog
        // the selection switches back to the original page
        // and the folder icon has been activated by the mouse
        // This is an upstream bug
        this._parentView.selectApp(this._id);
