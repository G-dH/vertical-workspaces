...
var AppDisplayModule = class {
    ...
    _activateModule() {
        ...
        if (shellVersion >= 43) {
            ...
            this._dummy = AppDisplay.BaseAppViewGridLayout;
            this._dummy = AppDisplay.AppGrid;
            delete this._dummy;
            this._overrides.addOverride('BaseAppViewGridLayout', AppDisplay.BaseAppViewGridLayout.prototype, BaseAppViewGridLayout);
    ...
    _updateAppDisplayProperties(reset = false) {
        ...
        if (reset) {
            ...
            if (!this._appGridLayoutSettings) {
                this._appGridLayoutSettings = ExtensionUtils.getSettings('org.gnome.shell');
    ...
    _updateDND(reset) {
        ...
        if (opt.APP_GRID_USAGE && !reset) {
            if (!this._origAppViewItemAcceptDrop)
                this._origAppViewItemAcceptDrop = AppDisplay.AppViewItem.prototype.acceptDrop;
            AppDisplay.AppViewItem.prototype.acceptDrop = () => false;
        } else if (this._origAppViewItemAcceptDrop) {
            AppDisplay.AppViewItem.prototype.acceptDrop = this._origAppViewItemAcceptDrop;
        }
    }
