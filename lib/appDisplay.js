...
var AppDisplayModule = class {
    constructor(me) {
        ...
        opt = Me.opt;
        _ = Me.gettext;
        IconSize = Me.imports.lib.iconGrid.IconSize;
...
const AppDisplayCommon = {
    ...
    _redisplay(results) {
        ...
        AppDisplay.BaseAppView.prototype._redisplay.bind(this)(results);
    },
...
const BaseAppViewCommon = {
    ...
    _redisplay(results) {
        if (opt._searchAppGridModeActive && !results)
            return;
...
const BaseAppViewGridLayoutHorizontal = {
    _getIndicatorsWidth(box) {
        ...
        const indicatorWidth = !this._grid.layout_manager._isFolder
...
const BaseAppViewGridLayoutVertical = {
    _getIndicatorsHeight(box) {
        ...
        const indicatorHeight = !this._grid.layout_manager._isFolder
