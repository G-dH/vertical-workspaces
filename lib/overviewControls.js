        ...
        if (opt.SEARCH_VIEW_ANIMATION && !this.dash.showAppsButton.checked && ![4, 8].includes(opt.WS_TMB_POSITION) /* && !opt.OVERVIEW_MODE2*/) {
            ...
            if (currentState < ControlsState.APP_GRID) {
                ...
                case 1:
                    ...
                    translationX = geometry.x + geometry.width - this._searchController.x + this._searchController.width;
                    translationY = 0;
                    break;
                case 2:
                    translationX = -this._searchController.allocation.x1 - 2 * this._searchController.width;
                    translationY = 0;
                    break;
                case 3:
                    translationX = 0;
                    translationY = geometry.y + geometry.height + this._searchController.y + this._searchController.height;
                    break;
                case 5:
                    translationX = 0;
                    translationY = -this._searchController.allocation.y1 - 2 * this._searchController.height;
                    break;
                }
            }
