...
var OverviewControlsModule = class {
    ...
    _activateModule() {
        ...
        if (dashToDockEnabled)
            this._overrides.addOverride('LayoutManagerDtD', Layout.LayoutManager.prototype, LayoutManagerDtD);
    }
...
const ControlsManagerCommon = {
    ...
    async runStartupAnimation(callback) {
        ...
        const onComplete = function () {
            ...
            const appDisplayModule = AppDisplayOverride.AppDisplayModule.prototype;
...
const LayoutManagerDtD = {
    _startupAnimation() {
        if (_Util.dashIsDashToDock() && !Meta.is_restart()) {
