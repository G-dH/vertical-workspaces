...
export var OverviewControlsModule = class {
...
const ControlsManagerCommon = {
    ...
    _onSearchChanged() {
        ...
        if (!searchActive) {
            ...
            // Ui.WorkspaceThumbnail.RESCALE_ANIMATION_TIME = 0; // 45 incompatible
        }
        ...
        if (opt.SEARCH_VIEW_ANIMATION && ![4, 8].includes(opt.WS_TMB_POSITION) /* && !opt.OVERVIEW_MODE2*/) {
            ...
            this._appDisplay.ease({
                ...
                onComplete: () => {
                    this._updateAppDisplayVisibility();
                    // Ui.WorkspaceThumbnail.RESCALE_ANIMATION_TIME = 200; // 45 incompatible
                },
            });
