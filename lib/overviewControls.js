...
export const OverviewControlsModule = class {
    ...
    _activateModule() {
        ...
        if (opt.ORIENTATION === Clutter.Orientation.VERTICAL)
            this._overrides.addOverride('ControlsManagerLayoutVertical', Main.overview._overview.controls.layoutManager, ControlsManagerLayoutVertical);
        else
            this._overrides.addOverride('ControlsManagerLayoutHorizontal', Main.overview._overview.controls.layoutManager, ControlsManagerLayoutHorizontal);
    ...
    _addClickToCloseOverview(reset) {
        ...
        const searchResults = overview.searchController._searchResults._content;
