...
export const OverviewBackgroundModule = class {
    ...
    _activateModule() {
        ...
        console.log('  OverviewBackground - Activated');
    }
    ...
    _disableModule() {
        ...
        console.log('  OverviewBackground - Disabled');
    }
};
...
export class OverviewBackgroundController {
    ...
    setBackground() {
        this._destroyBackgroundGroup();
        if (!this._shouldCreateBgManagers())
            return;
    ...
    _createBackgroundGroup() {
        const overviewGroup = Main.layoutManager.overviewGroup;
        this._vshellBackgroundGroup = new Meta.BackgroundGroup({ name: VSHELL_GROUP_NAME });
    ...
    runStartupAnimation() {
        ...
        this._vshellBackgroundGroup.opacity = 0;
