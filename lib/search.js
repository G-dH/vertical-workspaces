...
const SearchResultsView = {
    ...
    _updateSearchProgress() {
        ...
        const opaqueSearchResults = (opt.OVERVIEW_MODE2 && !opt.WORKSPACE_MODE) || opt.SEARCH_RESULTS_BG_STYLE;

        this._scrollView.visible = haveResults || opaqueSearchResults;
        this._statusBin.visible = !haveResults && !opaqueSearchResults;

        if (!haveResults && !opaqueSearchResults) {
