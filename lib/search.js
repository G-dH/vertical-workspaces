...
const SearchResultsView = {
    _doSearch() {
        ...
        this._providers.forEach(provider => {
            const onlyVShellProviders = this._terms.includes('wq//') || this._terms.includes('fq//') || this._terms.includes('eq//');
            if (!onlyVShellProviders || (onlyVShellProviders && (provider.id === 'open-windows' || provider.id === 'recent-files' || provider.id === 'extensions'))) {
