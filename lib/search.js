...
export var SearchModule = class {
    ...
    _activateModule() {
        ...
        this._overrides.addOverride('ListSearchResults', Ui.Search.ListSearchResults.prototype, ListSearchResults);
...
class SystemActionIcon extends Search.GridSearchResult {
    ...
    activate() {
        Misc.SystemActions.getDefault().activateAction(this.metaInfo['id']);
