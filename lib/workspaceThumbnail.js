...
export var WorkspaceThumbnailModule = class {
    ...
    _disableModule() {
        ...
        Ui.WorkspaceThumbnail.ThumbnailsBox._MAX_THUMBNAIL_SCALE = 0.05;
        this._clearGlobals();
    }
};
