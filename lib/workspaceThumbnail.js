...
const ThumbnailsBoxVertical = {
    ...
    vfunc_allocate(box) {
        ...
        // Hide thumbnails if scale is set to 0
        // thumbnailsBox containing thumbnails scaled to 0 still has some width
        if (this.allocation?.get_width() > 30)
            this.opacity = 255;
        else
            this.opacity = 0;
    },
...
const ThumbnailsBoxHorizontal = {
    ...
    vfunc_allocate(box) {
        ...
        // Hide thumbnails if scale is set to 0
        // thumbnailsBox containing thumbnails scaled to 0 still has some height
        if (this.allocation?.get_height() > 30)
            this.opacity = 255;
        else
            this.opacity = 0;
    },
